...
#define GFX_2BPP 0
#define GFX_4BPP 1
void __fastcall__ set_extended_gfx(unsigned char gfx_moode);

void __fastcall__ set_extended_gfx_params(unsigned char gfx_params);
...
void invert_c(unsigned char flag);
